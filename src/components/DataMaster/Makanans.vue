<template>
  <v-main class="list">
    <h3 class="font-weight-medium"
       style="text-align: center; font-style: italic;  font-size:72px; color:green;" font-weight-medium mb-5>Daftar Makanan</h3>
...
export default {
    ...
    methods: {
        ...
        //Simpan data Course
        save() {
            this.makanan.append('name', this.form.name);
            this.makanan.append('stok', this.form.stok);
            this.makanan.append('harga', this.form.harga);
